<script lang="ts">
	...
	let { id = '', type = 'text', label, value = $bindable(), disabled = false, min, rightContent }: {id: string, type: HTMLInputTypeAttribute, label?: string, value: unknown, disabled?: boolean, min?: number, rightContent?: Snippet} = $props();
</script>
